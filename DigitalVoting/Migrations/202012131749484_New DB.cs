namespace DigitalVoting.Migrations
{
    ...
    public partial class NewDB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Name = c.String(),
                        Candidates_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.Candidates_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Combinations", "BallotId", "dbo.Ballots");
            DropForeignKey("dbo.Ballots", "Candidates_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.Combinations", new[] { "BallotId" });
            ...
            DropIndex("dbo.Ballots", new[] { "Candidates_Id" });
